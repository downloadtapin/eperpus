            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <form class="row g-3" method="post" action="<?php echo base_url(); ?>laporan/printDataPeminjaman"
                            target="_blank">
                            <div class="col-auto">
                ...
                <div class="float-right card-header col-4">
                    <input type="text" placeholder="masukkan NISN. . ." class="form-control float-right"
                        id="name_filter">
                </div>
                <div class="card-body">
