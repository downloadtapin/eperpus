            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <div class="card-header">
                        Data Kelas
                        <a href="<?= base_url('kelas/tambah')?>" class="btn btn-sm btn-success float-right">
                                ...
                                <?php
                                    ...
                                    foreach($kelas as $a){
                                        echo "<tr>
                                            ...
                                            <td>".$a->kd_kelas."</td>
                                            <td>".$a->nama_kelas."</td>
                                            <td>".$a->jumlah_siswa."</td>                       
                                            <td>
                                                <a href=".base_url('kelas/ubah/'.$a->id_kelas)." class='btn btn-info btn-sm'>
                                                    <i class='fa fa-edit'></i> Ubah
                                                </a>
                                                <a href=".base_url('kelas/hapus/'.$a->id_kelas)." class='btn btn-danger btn-sm'
