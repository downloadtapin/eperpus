        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">Tambah Data Rak Buku</h2>
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            <div class="from-group row">
                                ...
                                <div class="col-md-9">
                                    <input value="<?php echo $kode ?>" type="text" name="kd_rak" required placeholder="Kode Rak Buku" class="form-control">
                                </div>
                            </div>
                            <br>
                            <div class="from-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="nama_rak" required placeholder="Nama Rak Buku" class="form-control">
                                </div>
                            </div>
                            <br>
