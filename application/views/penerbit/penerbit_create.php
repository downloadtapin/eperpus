        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">Tambah Data Penerbit</h2>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="from-group row">
                            ...
                            <br>
                            <div class="from-group row">
                                <label for="" class="col-md-3">Penerbit</label>
                                <div class="col-md-9">
                                    <input type="text" name="penerbit" required placeholder="Penerbit" class="form-control">
                                </div>
                            </div>
                            <br>
